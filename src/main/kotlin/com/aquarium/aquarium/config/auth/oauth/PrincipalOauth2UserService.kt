package com.aquarium.aquarium.config.auth.oauth

import com.aquarium.aquarium.config.auth.oauth.provider.FacebookUserInfo
import com.aquarium.aquarium.config.auth.oauth.provider.GoogleUserInfo
import com.aquarium.aquarium.config.auth.oauth.provider.NaverUserInfo
...
import com.aquarium.aquarium.config.auth.oauth.provider.OAuth2UserInfo
import com.aquarium.aquarium.domain.entity.User.User
import com.aquarium.aquarium.config.auth.PrincipalDetails
